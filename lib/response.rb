class Response
	...
	def self.instructions_message
		puts "A secret code will be generated by the computer consisting of four colors in a specific order. You have fifteen guesses to figure out the secret code. Enter p to play or q to quit."
	end
